...
questions13 = [{qid:"h_r3_1",index:"1.",context:" 飞机机械师",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
                  ...
                  {qid:"h_r3_5",index:"5.",context:"无线电报务员",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
                  {qid:"h_r3_6",index:"6.",context:"园艺师",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
                  {qid:"h_r3_7",index:"7.",context:"网络管理员",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
...
questions14 = [{qid:"h_s3_1",index:"1.",context:"街道、工会干部",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              ...
              {qid:"h_s3_5",index:"5.",context:"福利机构负责人",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              {qid:"h_s3_6",index:"6.",context:"心理咨询员",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              {qid:"h_s3_7",index:"7.",context:"导游",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
...
questions15 = [{qid:"h_i3_1",index:"1.",context:"气象学或天文学者",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              ...
              {qid:"h_i3_5",index:"5.",context:"数学学者",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              {qid:"h_i3_6",index:"6.",context:"科学杂志的编辑或作家",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              {qid:"h_i3_7",index:"7.",context:"地质学者",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
...
questions16 = [{qid:"h_e3_1",index:"1.",context:"厂长",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              ...
              {qid:"h_e3_5",index:"5.",context:"体育活动主办者",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              {qid:"h_e3_6",index:"6.",context:"销售部长",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              {qid:"h_e3_7",index:"7.",context:"个体工商业者",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
...
questions17 = [{qid:"h_a3_1",index:"1.",context:"乐队指挥",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              ...
              {qid:"h_a3_5",index:"5.",context:"记者",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              {qid:"h_a3_6",index:"6.",context:"画家、书法家",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              {qid:"h_a3_7",index:"7.",context:"歌唱家",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
...
questions18 = [{qid:"h_c3_1",index:"1.",context:"会计师",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              ...
              {qid:"h_c3_5",index:"5.",context:"成本核算员",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              {qid:"h_c3_6",index:"6.",context:"文书档案管理员",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              {qid:"h_c3_7",index:"7.",context:"打字员",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              {qid:"h_c3_8",index:"8.",context:"法庭书记员",options:[{text:"是",value:"true"},{text:"否",value:"false"}]} 
			 ];
