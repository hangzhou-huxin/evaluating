...
questions1 = [{qid:"h_r2_1",index:"1.",context:"能使用电锯、电钻和锉刀等工具",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
                  ...
                  {qid:"h_r2_5",index:"5.",context:"能够修理简单的电气用品",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
                  {qid:"h_r2_6",index:"6.",context:"能修理家具",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
                  {qid:"h_r2_7",index:"7.",context:"能修理收录机",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
...
questions2 = [{qid:"h_a2_1",index:"1.",context:"能演奏乐器",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              ...
              {qid:"h_a2_5",index:"5.",context:"能绘画、素描或书法",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              {qid:"h_a2_6",index:"6.",context:"能雕刻、剪纸或泥塑",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              {qid:"h_a2_7",index:"7.",context:"能设计板报、服装或家具",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
...
questions3 = [{qid:"h_i2_1",index:"1.",context:"懂得真空管或晶体管的作用",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              ...
              {qid:"h_i2_5",index:"5.",context:"会使用显微镜",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              {qid:"h_i2_6",index:"6.",context:"能找到三个星座",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              {qid:"h_i2_7",index:"7.",context:"能独立进行调查研究",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
...
questions4 = [{qid:"h_s2_1",index:"1.",context:"有向各种人说明解释的能力",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              ...
              {qid:"h_s2_5",index:"5.",context:"会邀请人、招待人",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              {qid:"h_s2_6",index:"6.",context:"能简单易懂地教育儿童",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              {qid:"h_s2_7",index:"7.",context:"能安排会议等活动顺序",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
...
questions5 = [{qid:"h_e2_1",index:"1.",context:"担任过学生干部并且干得不错",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              ...
              {qid:"h_e2_5",index:"5.",context:"曾作为俱乐部或社团的负责人",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              {qid:"h_e2_6",index:"6.",context:"向领导提出建议或反映意见",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              {qid:"h_e2_7",index:"7.",context:"知道怎样做能成为一个优秀的领导者",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
...
questions6 = [{qid:"h_c2_1",index:"1.",context:"会熟练的打印中文",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              ...
              {qid:"h_c2_5",index:"5.",context:"会用算盘",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              {qid:"h_c2_6",index:"6.",context:"能在短时间内分类和处理大量文件",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              {qid:"h_c2_7",index:"7.",context:"能搜集数据",options:[{text:"是",value:"true"},{text:"否",value:"false"}]},
              {qid:"h_c2_8",index:"8.",context:"善于为自己或集体做财务预算表",options:[{text:"是",value:"true"},{text:"否",value:"false"}]} 
			 ];
