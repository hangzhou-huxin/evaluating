...
<body style="margin:0 auto;width: 75%;">
 <h1 class="page-header" style="text-align:center;">${category.name}</h1>
  <p>${errMsg}</p>
  <div id="test" class="container-fluid">
	 <form class="form-horizontal" action="<%=request.getContextPath()%>/escape/evaluation/step.do" method="post">
